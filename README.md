...
```
devops-diplom-k8s/
├── ingress/           # Манифесты для развертывания и конфигурации ingress-контроллера nginx
├── monitoring/        # Конфигурации для стека мониторинга (Prometheus, Grafana, Alertmanager)
...
`Ingress`-контроллер был установлен в выделенном namespace `ingress-nginx`. Манифесты для его установки и базовой конфигурации находятся в директории `./ingress/`.
...
Все компоненты мониторинга изолированы в namespace monitoring. Конфигурации для их установки находятся в `./monitoring/`.
